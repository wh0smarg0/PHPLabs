...
$menu = [
    ...
    "page5.php" => "Контакти",
    "page_create.php" => "Створити Collapse",
    "page_display.php" => "Показати Collapse",
    "page_anim.php" => "Анімація (Практ. 5)"
];
...
$default_texts = [
    ...
    "page_create.php" => [
        "content_t0" => "<h3>Примітка:</h3><p>Ця сторінка призначена тільки для конфігурації. Основний контент відсутній.</p>",
        "content_t1" => " ", // Центральний блок (main) ми очистили для форми, тому залишаємо пробіл
        "content_t2" => "<h3>Інструкції:</h3><p>Використовуйте кнопки для додавання, редагування та видалення елементів набору Collapse.</p>",
        "content_t3" => "<h3>Збереження:</h3><p>Натисніть 'Зберегти на сервер', щоб оновити контент на Сторінці Відображення.</p>",
        "content_t4" => "Автор: Сахно Маргарита, 2025"
    ],

    "page_display.php" => [
        "content_t0" => "<h3>Відображення:</h3><p>Тут ви бачите динамічно згенерований контент.</p>",
        "content_t1" => " ",
        "content_t2" => "<h3>Статус:</h3><p>Перевірка змін відбувається автоматично.</p>",
        "content_t3" => "<h3>Контроль:</h3><p>Дані оновлюються кожні 5 секунд.</p>",
        "content_t4" => "Автор: Сахно Маргарита, 2025"
    ],

    "page_anim.php" => [
    "content_t0" => "<h3>Мета:</h3><p>Експеримент із завантаженням. Порівняння AJAX та LocalStorage для логування подій.</p>",
    "content_t1" => " ", // Центральний блок (main) ми очистили для анімації
    "content_t2" => "<h3>Події:</h3><p>Кожен рух, зіткнення, старт чи стоп фіксується і відправляється на сервер.</p>",
    "content_t3" => "<h3>Контроль:</h3><p>Кнопка 'Close' відправляє всі накопичені дані з LocalStorage.</p>",
    "content_t4" => "Автор: Сахно Маргарита, 2025"
    ],

    "page_logs.php" => [
    "content_t0" => "<h3>Аналіз:</h3><p>На цій сторінці відображаються результати логування, згруповані за методом відправки (Immediate та LocalStorage).</p>",
    "content_t1" => " ", // Залишаємо порожнім, оскільки в main буде сама таблиця
    "content_t2" => "<h3>Immediate Log:</h3><p>Показує час, коли подія була зафіксована клієнтом (Local Time) і коли вона потрапила на сервер (Server Time).</p>",
    "content_t3" => "<h3>LocalStorage Log:</h3><p>Показує час, коли подія була зафіксована клієнтом. Відправка на сервер відбувається єдиним пакетом після натискання 'Close'.</p>",
    "content_t4" => "Автор: Сахно Маргарита, 2025 (Сторінка аналізу логів)"
    ],
